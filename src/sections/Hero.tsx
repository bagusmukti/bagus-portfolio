      ...
      <div className={styles.inner}>
        <div className={styles.textSide}>
          ...
          <div className={styles.content}>
            <div className={styles.badge}>✦ Software Engineer · Indonesia</div>
            ...
            <div className={styles.btns}>
              ...
              <button className={styles.btnPch} onClick={() => onNav('about')}>
                About me
              </button>
            </div>
          </div>
          ...
          <div className={styles.photoSide}>
            <div className={styles.photoRing}>
              <div className={styles.photoInner}>
                <img src={personal.photo} alt={personal.name} className={styles.photoImg} />
              </div>
            </div>
          </div>
        )}
